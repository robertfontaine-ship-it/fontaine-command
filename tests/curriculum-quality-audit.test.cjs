...
const scripts=[
  ...
  'fashion-lesson-packages.js','fashion-mp1-quality-patch.js','mp1-fashion-final-quality-patch.js','entrepreneurship-lesson-packages.js','entrepreneurship-mp1-quality-patch.js','mp1-priority-quality-patch.js','mp1-ideas-color-style-quality-patch.js','mp1-trends-promotion-quality-patch.js','mp1-entrepreneurship-research-ownership-quality-patch.js',
...
test('repaired Fashion and Entrepreneurship MP1 lessons are strong',()=>{
  const ids=['ENT-001','ENT-002','ENT-004','ENT-005','ENT-006','ENT-007','ENT-009','ENT-010','ENT-011','ENT-012','ENT-013','ENT-014','ENT-015','ENT-016','ENT-017','ENT-018','FASH-001','FASH-002','FASH-004','FASH-005','FASH-007','FASH-008','FASH-009','FASH-011','FASH-012','FASH-013','FASH-014','FASH-015','FASH-016','FASH-017','FASH-018','FASH-019','FASH-020'];
...
test('all released lessons are at least Minor Polish',()=>{
  ...
  assert.ok(audit.strong>=153,`strong ${audit.strong}`);
...
test('quality dashboard loads after all curriculum packages and before usability wrapper',()=>{
  ...
  assert.ok(position('mp1-fashion-final-quality-patch.js')<position('fashion-migration-audit.js'));
